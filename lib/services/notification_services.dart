...
class NotifyHelper {
  ...
  tz.TZDateTime _nextInstanceOfTenAM(
    ...
    tz.TZDateTime scheduledDate =
        tz.TZDateTime(tz.local, formattedLocalDate.year, formattedLocalDate.month, formattedLocalDate.day, hour, minutes);

    scheduledDate = remindAfter(remind, scheduledDate);
    if (scheduledDate.isBefore(now)) {
      ...
      if (repeat == 'Monthly') {
        scheduledDate = tz.TZDateTime(tz.local, now.year, (formattedDate.month)+1,
